...
{
	private LinkedHashSet<AVPairs> avpairs = new LinkedHashSet<AVPairs>();
	...
	public LinkedHashSet<AVPairs> getPairs() {
		return this.avpairs;
	}
	...
	public void addPair(String value) {
		this.avpairs.add(new AVPairs(this.schema.getAttrs().get(avpairs.size()), value, avpairs.size()));
	}
	public void addValue(String attr, String value) {
		int index = this.schema.getAttrs().indexOf(attr);
		this.avpairs.add(new AVPairs(attr, value, index));
	}
